<template>
  <v-sheet rounded="rounded" class="bg-transparent ma-0 pa-0 justify-center align-center">
    <v-parallax :src="background" style="overflow: hidden; height: 100vh;">
              ...
              <v-hover v-slot="{ isHovering, props }">
                <router-link to="/timetable">
                  <v-btn class="text-h5 py-1 px-8 font-weight-bold rounded-lg text-overflow ml-2 mr-6" width="100%"
                    height="80px" :color="isHovering ? 'primary' : undefined" v-bind="props">
        ...
        <div class="rounded-lg justify-center w-100">
          <v-col class="d-flex align-center justify-center pa-0 my-5">
            <router-link to="/timetable" class="w-100">
              <v-btn class="py-2 rounded-lg text-overflow homepage-btn" width="100%" min-width="170px" height="80px">
                <v-icon class="mr-2" icon="mdi-calendar-check" />
                時間查詢
              </v-btn>
            </router-link>
      ...
      <!-- 更多資訊 -->
      <v-fab class="mr-3 mb-6" :color="width > 960 ? `grey-lighten-5` : `grey-darken-4`" size="35" fixed app appear
...
.background-overlay {
  ...
  width: 100%;
  height: 100%;
  background: linear-gradient(180deg, rgba(255, 255, 255, 0) 0%, #ffffff9f 100%);
}
...
@media screen and (min-width: 960px) {
  ...
  .background-overlay {
    background: linear-gradient(270deg, rgba(255, 255, 255, 0) 0%, #ffffff9f 100%);
  }
}
